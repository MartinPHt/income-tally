...
class InsidesPageState extends State<InsidesPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (screenWidth <= 600) {
      borderTitleStyle = const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, fontFamily: 'Roboto');
    } else if (screenWidth <= 1200) {
      borderTitleStyle = const TextStyle(fontSize: 20, fontWeight: FontWeight.bold);
    } else {
      borderTitleStyle = const TextStyle(fontSize: 22, fontWeight: FontWeight.bold);
    }
                        ...
                        children: [
                          Container(
                            margin: const EdgeInsets.only(left: 10, bottom: 20),
                              child: Text('Expense Analytics', style: borderTitleStyle)),
                          Expanded(
                            child: ValueListenableBuilder(
                              valueListenable: DataController
                                  .instance.expensesPerTypeNotifier,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                        ...
                        child: Text('Dashboard', style: borderTitleStyle)),
                    Expanded(
